...
import { 
  ...
  ImageIcon, FileText, Download, Eye, Edit, Trash2, CheckCircle, 
  ...
  const exportData = [
    ...
    ...eventRegistrations.map(reg => {
      ...
      return {
        ...
        Value: \`Type: \${reg.participationType} | Contact: \${isTeam ? reg.teamId.createdBy?.email : reg.studentId?.email} | Size: \${isTeam ? (1 + (reg.teamId.currentMembers?.length || 0) + (reg.teamId.offlineMembers?.length || 0)) : 1}\`
      }
    })
  ]
                  ...
                  <table className="w-full text-left whitespace-nowrap">
                    <thead className="bg-gray-50 border-y border-gray-200">
                      <tr>
                        ...
                        <th className="px-4 py-3 text-xs font-bold text-gray-500 uppercase tracking-wider">Leader Email</th>
...
fs.writeFileSync('/Users/fahadfurquan/Desktop/ALL IN ONE/COLLEGE CAMPUS/src/pages/AdminEventDetailsPage.jsx', code);
